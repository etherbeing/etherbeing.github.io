...
import type { LiquidEtherWebGL, SimOptions, Uniforms } from "../types";
import face_vert from "../shaders/face_vert.glsl?raw";
import advection_frag from "../shaders/advection_frag.glsl?raw";
import line_vert from "../shaders/line_vert.glsl?raw";
import mouse_vert from "../shaders/mouse_vert.glsl?raw";
import externalForce_frag from "../shaders/external_force_frag.glsl?raw";
import viscous_frag from "../shaders/viscous_frag.glsl?raw";
import divergence_frag from "../shaders/divergence_frag.glsl?raw";
import poisson_frag from "../shaders/poisson_frag.glsl?raw";
import pressure_frag from "../shaders/pressure_frag.glsl?raw";
import color_frag from "../shaders/color_frag.glsl?raw";
...
export class ShaderPass {
    ...
    protected mouse: MouseClass;
    constructor(props: any, common: CommonClass, mouse: MouseClass) {
        this.props = props || {};
        this.mouse = mouse
        this.common = common
...
export class Advection extends ShaderPass {
    ...
    constructor(simProps: any, common: CommonClass, mouse: MouseClass) {
        super({
            material: {
...
export class ExternalForce extends ShaderPass {
    ...
    constructor(simProps: any, common: CommonClass, mouse: MouseClass) {
        super({ output: simProps.dst }, common, mouse);
        this.init(simProps);
    }
    init(simProps: any) {
        super.init();
...
export class Output {
    ...
    private common: CommonClass;
    private mouse: MouseClass;
    constructor(colors: Array<string>, common: CommonClass, mouse: MouseClass) {
        this.common = common
        this.mouse = mouse
        ...
        this.output = new THREE.Mesh(
            ...
            new THREE.RawShaderMaterial({
                ...
                uniforms: {
                    ...
                    palette: { value: this.makePaletteTexture(colors) },
    ...
    makePaletteTexture(stops: string[]): THREE.DataTexture {
        let arr: string[];
...
export class WebGLManager implements LiquidEtherWebGL {
    ...
    constructor(props: any, colors: Array<string>, isVisible: boolean, animationFrame: number | null) {
    ...
    init() {
        ...
        this.output = new Output(this.colors, this.common, this.mouse);
    }
    resize() {
        this.common.resize();
        this.output.resize();
