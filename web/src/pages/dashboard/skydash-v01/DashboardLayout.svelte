...
<svelte:head>
    ...
    <link
        rel="stylesheet"
        href="/src/assets/dashboard/vendors/feather/feather.css"
    />
    <link
        rel="stylesheet"
        href="/src/assets/dashboard/vendors/ti-icons/css/themify-icons.css"
    />
    <link
        rel="stylesheet"
        href="/src/assets/dashboard/vendors/css/vendor.bundle.base.css"
    />
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link
        rel="stylesheet"
        href="/src/assets/dashboard/vendors/datatables.net-bs4/dataTables.bootstrap4.css"
    />
    <link
        rel="stylesheet"
        href="/src/assets/dashboard/vendors/ti-icons/css/themify-icons.css"
    ...
    <link
        rel="stylesheet"
        type="text/css"
        href="/src/assets/dashboard/js/select.dataTables.min.css"
    />
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link
        rel="stylesheet"
        href="/src/assets/dashboard/css/vertical-layout-light/style.css"
    />
    <!-- endinject -->
    <link rel="shortcut icon" href="/src/assets/dashboard/images/favicon.png" />

    <!-- plugins:js -->
    <script
        defer
        async={false}
        src="/src/assets/dashboard/vendors/js/vendor.bundle.base.js"
    ></script>
    <!-- endinject -->
    ...
    <script
        defer
        async={false}
        src="/src/assets/dashboard/vendors/chart.js/Chart.min.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/vendors/datatables.net/jquery.dataTables.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/vendors/datatables.net-bs4/dataTables.bootstrap4.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/dataTables.select.min.js"
    ></script>
    ...
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/off-canvas.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/hoverable-collapse.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/template.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/settings.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/todolist.js"
    ></script>
    <!-- endinject -->
    ...
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/dashboard.js"
    ></script>
    <script
        defer
        async={false}
        src="/src/assets/dashboard/js/Chart.roundedBarCharts.js"
    ></script>
</svelte:head>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        >
            ...
            <a class="navbar-brand brand-logo-mini" href="index.html"
                ><img
                    src="/src/assets/dashboard/images/logo-mini.svg"
                    alt="logo"
                /></a
            >
        </div>
        ...
        >
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item nav-profile dropdown">
                    ...
                    >
                        <img
                            src="/src/assets/dashboard/images/faces/face28.jpg"
                            alt="profile"
                        />
                    </a>
                    <div
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input
                                            ...
                                            type="checkbox"
                                        />
                                        Resolve all the low priority tickets due
                                        today
                                    </label>
                                </div>
                                <i class="remove ti-close"></i>
                ...
                >
                    ...
                    <ul class="chat-list">
                        <li class="list active">
                            <div class="profile">
                                <img
                                    src="/src/assets/dashboard/images/faces/face1.jpg"
                                    alt="image"
                        ...
                        <li class="list">
                            <div class="profile">
                                <img
                                    src="/src/assets/dashboard/images/faces/face2.jpg"
                                    alt="image"
                        ...
                        <li class="list">
                            <div class="profile">
                                <img
                                    src="/src/assets/dashboard/images/faces/face3.jpg"
                                    alt="image"
                                /><span class="online"></span>
                            </div>
                            <div class="info">
                        ...
                        <li class="list">
                            <div class="profile">
                                <img
                                    src="/src/assets/dashboard/images/faces/face4.jpg"
                                    alt="image"
                                /><span class="offline"></span>
                            </div>
                            <div class="info">
                        ...
                        <li class="list">
                            <div class="profile">
                                <img
                                    src="/src/assets/dashboard/images/faces/face5.jpg"
                                    alt="image"
                                /><span class="online"></span>
                            </div>
                            <div class="info">
                        ...
                        <li class="list">
                            <div class="profile">
                                <img
                                    src="/src/assets/dashboard/images/faces/face6.jpg"
                                    alt="image"
                                /><span class="online"></span>
                            </div>
                            <div class="info">
                    ...
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card tale-bg">
                            <div class="card-people mt-auto">
                                <img
                                    src="/src/assets/dashboard/images/dashboard/people.svg"
                                    alt="people"
                                />
