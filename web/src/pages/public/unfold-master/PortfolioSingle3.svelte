  ...
  >
    <div class="portfolio-single-inner">
      ...
      <div class="row justify-content-between align-items-stretch">
        <div class="col-lg-8">
          <p>
            <a href="/src/assets/dark/images/work_2_full.jpg" data-fancybox="gal"
              ><img
                src="/src/assets/dark/images/work_2_full.jpg"
                alt="Image"
                class="img-fluid"
              /></a
            >
          ...
          <p>
            <a href="/src/assets/dark/images/work_2_a_full.jpg" data-fancybox="gal"
              ><img
                src="/src/assets/dark/images/work_2_a_full.jpg"
                alt="Image"
                class="img-fluid"
              /></a
            >
          ...
          <p>
            <a href="/src/assets/dark/images/work_2_b_full.jpg" data-fancybox="gal"
              ><img
                src="/src/assets/dark/images/work_2_b_full.jpg"
                alt="Image"
                class="img-fluid"
              /></a
            >
              ...
              <div class="col-md-12 mb-4">
                <div class="detail-v1">
                  ...
                  <span class="detail-val"
                    ><a href="#">Identity</a>, <a href="#">Web Design</a></span
                  >
                </div>
              </div>
              <div class="col-md-12 mb-4">
