<section class="flex justify-center items-center pt-[5%] container">
  <h1 class="text-center">Copyright</h1>
  <h2 class="text-center">Esteban Chacon Martin</h2>
  <article>
    <p class="text-justify">All rights reserved.</p>
  </article>
  <article>
    ...
    <p style="text-align:center;">
      For more awesome templates please visit <strong
        ><a href="https://colorlib.com/wp/templates/">Colorlib</a></strong
      >.
    </p>
    <br />
    ...
    <p style="text-align:center;">
      <strong
        >More information about the license is available <a
          href="https://colorlib.com/wp/licence/">here</a
        ></strong
      >.
    </p>
  </article>
