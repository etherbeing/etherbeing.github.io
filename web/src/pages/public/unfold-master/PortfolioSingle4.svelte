  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-10 mx-auto text-center">
        ...
        <h2 class="subheading" data-aos="fade-up" data-aos-delay="100">Far far away, behind the word mountains, far from
          the countries.</h2>
      </div>
  ...
  <div class="portfolio-single-wrap unslate_co--section" id="portfolio-single-section">
    <div class="portfolio-single-inner">
      ...
      <div class="row justify-content-between align-items-stretch">
        ...
        <div class="col-lg-8">
          <p><a href="/src/assets/dark/images/work_3_a_full.jpg" data-fancybox="gal"><img src="/src/assets/dark/images/work_3_a_full.jpg" alt="Image"
                class="img-fluid"></a></p>
          <p><a href="/src/assets/dark/images/work_3_full.jpg" data-fancybox="gal"><img src="/src/assets/dark/images/work_3_full.jpg" alt="Image"
                class="img-fluid"></a></p>
        </div>
